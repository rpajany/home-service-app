...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#5b32cf] bg-[#7045e8] text-white shadow-sm">
      {/* =========================
          HEADER BAR
      ========================= */}
          ...
          {user ? (
            ...
            >
              ...
              {profileOpen && (
                <div
                  role="menu"
                  className="absolute right-0 top-[52px] w-64 overflow-hidden rounded-xl border border-[#e7e2ee] bg-white text-[#292332] shadow-xl"
                >
                  <div className="border-b border-[#eeeaf3] px-4 py-3">
                    <p className="truncate text-sm font-bold text-[#171323]">
                      {user.name}
                    </p>

                    <p className="truncate text-xs text-[#7b7886]">
                      {user.email}
                    </p>
                  </div>
                  ...
                  <div className="p-1.5">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold hover:bg-[#f5f1fb]"
                    >
                      <UserRound
                        size={17}
                    ...
                    <button
                      ...
                      onClick={logout}
                      disabled={loggingOut}
                      className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-red-600 hover:bg-red-50 disabled:opacity-60"
                    >
                      <LogOut size={17} />
      ...
      ========================= */}
      {mobileOpen && (
        <div className="border-t border-white/20 bg-white px-4 py-4 text-[#292332] shadow-lg md:hidden">
          <div className="container-page flex flex-col gap-1 text-sm font-semibold">
            ...
            <Link
              href="/"
              onClick={() => setMobileOpen(false)}
              className="rounded-md px-3 py-3 hover:bg-[#f5f1fb]"
            >
              Home
            </Link>
            ...
            {user && (
              <>
                <Link
                  ...
                  className="flex items-center gap-3 rounded-md px-3 py-3 hover:bg-[#f5f1fb]"
                >
                  <UserRound
                    size={18}
                    className="text-[#7045e8]"
                ...
                <button
                  type="button"
                  className="flex items-center gap-3 rounded-md px-3 py-3 text-left text-red-600 hover:bg-red-50"
                  onClick={logout}
                  disabled={loggingOut}
                >
                  <LogOut size={18} />
